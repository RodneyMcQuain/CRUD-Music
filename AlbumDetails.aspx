...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="center-container">
            ...
            <div class="general-contianer">
                <asp:TextBox ID="tbArtistAlbumDetails" CssClass="form-control input-lg" runat="server" placeholder="Artist"></asp:TextBox>
                <asp:TextBox ID="tbAlbumAlbumDetails" CssClass="form-control input-lg" runat="server" placeholder="Album"></asp:TextBox>
            </div>

            <div class="general-contianer">
                <asp:LinkButton ID="btUpdate" runat="server" CssClass="btn" text="Update" OnClick="btUpdate_Click">
                    <span aria-hidden="true" class="fa fa-sync-alt"></span> Update
                </asp:LinkButton>

                <asp:LinkButton ID="btDelete" runat="server" CssClass="btn" text="Delete" OnClick="btDelete_Click">
